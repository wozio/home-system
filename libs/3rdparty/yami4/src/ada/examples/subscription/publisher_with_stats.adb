...
with YAMI.Activity_Statistics_Monitors;
with YAMI.Agents;
...
procedure Publisher_With_Stats is
begin
   ...
   declare
      ...
      Default_Options : constant YAMI.Parameters.Parameters_Collection :=
        YAMI.Parameters.Make_Parameters;
      Stats : aliased YAMI.Activity_Statistics_Monitors.Activity_Statistics_Monitor;
      
      Publisher_Agent : aliased YAMI.Agents.Agent :=
        YAMI.Agents.Make_Agent (Stats'Unchecked_Access, Default_Options);
   ...
   begin
      Publisher_Agent.Register_Object ("stats", Stats'Unchecked_Access);
