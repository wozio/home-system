...
package YAMI.Core.New_Connection_Handlers is
   ...
   --
   --  Reports the new incoming connection.
   --  Source is the resolved name of listener that accepted
   --  the new connection.
   --
...
end YAMI.Core.New_Connection_Handlers;
