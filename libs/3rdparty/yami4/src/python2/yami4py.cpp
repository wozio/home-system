    ...
    PyObject *self, PyObject *args)
{
    ...
    int priority;
    int auto_connect;
    if (!PyArg_ParseTuple(args, "Kssst#iii", &pa, &target,
            &object_name, &message_name, &serialized_content, &dummy, &buffer_len,
    ...
    PyObject *self, PyObject *args)
{
    ...
    const char * target;
    int priority;
    if (!PyArg_ParseTuple(args, "Ksi", &pa, &target, &priority))
    {
        return NULL;
    }
    ...
    PyObject *self, PyObject *args)
{
    ...
    int buffer_len;
    int priority;
    if (!PyArg_ParseTuple(args, "Kt#ii", &pmsg,
    ...
    PyObject *self, PyObject *args)
{
    ...
    const char * reason;
    int priority;
    if (!PyArg_ParseTuple(args, "Ksi", &pmsg, &reason, &priority))
    {
        return NULL;
    }
