...
LDLIBSOPTIONS=-L../common/yami4/lib -lPocoFoundation -lPocoNet -lboost_date_time -lboost_program_options -lboost_system -lboost_thread ../common/common/../bin/Debug/libcommon.a -lyamicpp -lyamicore -lpthread

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../bin/${CND_CONF}/dhw-recirculation

../bin/${CND_CONF}/dhw-recirculation: ../common/common/../bin/Debug/libcommon.a

../bin/${CND_CONF}/dhw-recirculation: ${OBJECTFILES}
	${MKDIR} -p ../bin/${CND_CONF}
	${LINK.cc} -o ../bin/${CND_CONF}/dhw-recirculation ${OBJECTFILES} ${LDLIBSOPTIONS}
