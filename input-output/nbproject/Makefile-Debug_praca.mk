...
LDLIBSOPTIONS=-lusb -lPocoFoundation -lPocoNet -lboost_program_options -lboost_filesystem -lboost_system -lboost_thread -lpthread ../common/../Debug_praca/libcommon.a ../yami4/yami4-cpp/../../Debug_praca/libyami4-cpp.a ../yami4/yami4-core/../../Debug_praca/libyami4-core.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../${CND_CONF}/input-output

../${CND_CONF}/input-output: ../common/../Debug_praca/libcommon.a

../${CND_CONF}/input-output: ../yami4/yami4-cpp/../../Debug_praca/libyami4-cpp.a

../${CND_CONF}/input-output: ../yami4/yami4-core/../../Debug_praca/libyami4-core.a
...
.build-subprojects:
	...
	cd ../yami4/yami4-cpp && ${MAKE}  -f Makefile CONF=Debug_praca
	cd ../yami4/yami4-core && ${MAKE}  -f Makefile CONF=Debug_praca
	cd ../common && ${MAKE}  -f Makefile CONF=Debug_praca
...
.clean-subprojects:
	...
	cd ../yami4/yami4-cpp && ${MAKE}  -f Makefile CONF=Debug_praca clean
	cd ../yami4/yami4-core && ${MAKE}  -f Makefile CONF=Debug_praca clean
	cd ../common && ${MAKE}  -f Makefile CONF=Debug_praca clean
