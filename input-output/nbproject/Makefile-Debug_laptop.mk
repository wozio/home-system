...
LDLIBSOPTIONS=-lusb -lPocoFoundation -lPocoNet -lboost_filesystem -lboost_program_options -lboost_system -lboost_thread -lpthread ../common/common/../bin/Debug_laptop/libcommon.a -lyamicpp -lyamicore

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../bin/${CND_CONF}/input-output

../bin/${CND_CONF}/input-output: ../common/common/../bin/Debug_laptop/libcommon.a
